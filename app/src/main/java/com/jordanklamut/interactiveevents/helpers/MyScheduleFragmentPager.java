...
import com.jordanklamut.interactiveevents.MyScheduleFragment_Tab;
import com.jordanklamut.interactiveevents.ScheduleFragment_Tab;

public class MyScheduleFragmentPager extends FragmentPagerAdapter {

    DatabaseManager dm;
    Activity a;

    public MyScheduleFragmentPager(FragmentManager fm, Activity activity, DatabaseManager databaseManager) {
        super(fm);
        a = activity;
        dm = databaseManager;
    }
